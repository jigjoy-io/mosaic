...
export class Claude47Opus implements GenerativeModel, ReasoningEffort<AnthropicReasoningEffortType>, ToolCallingCapability {
	readonly specification = {
		name: "claude-opus-4-7-20251101",
		supportReasoningEffort: true,
		defaultReasoningEffort: "medium" as AnthropicReasoningEffortType,
